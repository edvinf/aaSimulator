...
play_LHTR_battle <- function(oolAttacker, oolDefender, retreat=NULL, verbose=F, suppressChecks=F){
  ...
  result$unitsAttacker <- result$unitsAttacker[result$unitsAttacker %in% unitlist[!unitlist$virtualUnit]$shortcut]
  result$unitsDefender <- result$unitsDefender[result$unitsDefender %in% unitlist[!unitlist$virtualUnit]$shortcut]
